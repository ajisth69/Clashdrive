  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 animate-slide-up">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-extrabold text-surface-900 tracking-tight">API Setup</h2>
      ...
      {/* Info Banner */}
      <div className="flex gap-3 bg-brand-500/5 dark:bg-brand-500/10 border border-brand-500/20 rounded-2xl p-4 text-xs text-surface-650 dark:text-surface-700 leading-relaxed shadow-sm">
        ...
        <div>
          <span className="font-bold text-surface-900">API Credentials Required:</span> Obtain your <code className="bg-surface-200 dark:bg-surface-300/20 px-1 py-0.5 rounded font-mono">api_id</code> and <code className="bg-surface-200 dark:bg-surface-300/20 px-1 py-0.5 rounded font-mono">api_hash</code> by logging into{" "}
          <a
            href="https://my.telegram.org"
            target="_blank"
            rel="noopener noreferrer"
            className="text-brand-500 hover:text-brand-600 underline font-semibold transition-all duration-200 cursor-pointer"
          >
            my.telegram.org
          </a>
